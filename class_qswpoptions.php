...
class QSWPOptions
{
    ...
    var $thankyou_page = '<h1>Thank you for your order %%first_name%% %%last_name%%!</h1>You have successfully completed the order process! Please use the link(s) below to download your copy:<strong>Use the link below the start the download:</strong><a href="%%downloadlink%%" target="_blank">%%item_name%%</a> (%%filesize%%)<strong>Other formats of the ebook:</strong>%%download_links%%<h3>Details for your order:</h3>Order #: %%order_id%%Transaction: %%txn_id%%Amount: %%mc_currency%% %%mc_gross%%<strong>Your password is: %%payer_email%%</strong>Thank you!';
